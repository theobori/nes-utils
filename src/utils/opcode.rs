...
pub fn get_nes_opcode(code: &u8) -> Option<OpCode> {
    let ret = match code {
        ...
        // nop
        0xea => ("nop", 3, AddressingMode::AbsoluteX),
        ...
        // nop
        0x80 => ("nop", 2, AddressingMode::Immediate),
        0x82 => ("nop", 2, AddressingMode::Immediate),
        0x89 => ("nop", 2, AddressingMode::Immediate),
        0xc2 => ("nop", 2, AddressingMode::Immediate),
        0xe2 => ("nop", 2, AddressingMode::Immediate),
        0x04 => ("nop", 2, AddressingMode::ZeroPage),
        0x44 => ("nop", 2, AddressingMode::ZeroPage),
        0x64 => ("nop", 2, AddressingMode::ZeroPage),
        0x14 => ("nop", 2, AddressingMode::ZeroPageX),
        0x34 => ("nop", 2, AddressingMode::ZeroPageX),
        0x54 => ("nop", 2, AddressingMode::ZeroPageX),
        0x74 => ("nop", 2, AddressingMode::ZeroPageX),
        0xd4 => ("nop", 2, AddressingMode::ZeroPageX),
        0xf4 => ("nop", 2, AddressingMode::ZeroPageX),
        0x0c => ("nop", 3, AddressingMode::Absolute),
        0x1c => ("nop", 3, AddressingMode::AbsoluteX),
        0x3c => ("nop", 3, AddressingMode::AbsoluteX),
        0x5c => ("nop", 3, AddressingMode::AbsoluteX),
        0x7c => ("nop", 3, AddressingMode::AbsoluteX),
        0xdc => ("nop", 3, AddressingMode::AbsoluteX),
        0xfc => ("nop", 3, AddressingMode::AbsoluteX),
